...
Also, over 80% of the raw code you see in this repository is AI generated. How my workflow for coding works is, I roughly design a new feature or bug-update or whatever myself by hand, and I let an LLM either finish it up, integrate it with the rest of the codebase, look for any bugs, update the performance, or guide me if what I am doing is fundimentally wrong. What this means is even though a majority of the code is AI generated, it still carrys through my intentions and the design I have in mind as intended. In my opinion, agenticly assisted coding is the future for SWE, and this method of coding is how you *actually* become a 10x engineer. Without LLMs, this project would have taken much much longer to get to the degree I was able to get it to in just a couple of weeks. The code that is AI generated is still 100% checked by me, this just serves as a disclamer that the code in this project is not 100% human-generated, however it is not (in my eyes) what people call "slop" or coded in the practice of "vibe coding". There is a real human in the loop, doing all the critical decisions, which is what allowed me to scale this independently to a degree that would have been impossible when I first started, and is the main reason Jaithon 3 exists.
