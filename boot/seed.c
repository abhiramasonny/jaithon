...
static const SeedSource kSources[] = {
    {"jaithon/ast.jai", 0, 19596, 39544},
    {"jaithon/ast_encode.jai", 19596, 13646, 28409},
    {"jaithon/ast_unparse.jai", 33242, 16554, 33529},
    {"jaithon/compile/check/assign.jai", 49796, 3094, 6164},
    {"jaithon/compile/check/checker.jai", 52890, 12960, 22906},
    {"jaithon/compile/check/ctx.jai", 65850, 13648, 26691},
    {"jaithon/compile/check/decl.jai", 79498, 18579, 33779},
    {"jaithon/compile/check/expr.jai", 98077, 23960, 44141},
    {"jaithon/compile/check/fold.jai", 122037, 8659, 18707},
    {"jaithon/compile/check/kinds.jai", 130696, 1115, 1793},
    {"jaithon/compile/check/modsig.jai", 131811, 6690, 11905},
    {"jaithon/compile/check/nominal.jai", 138501, 2222, 4353},
    {"jaithon/compile/check/operator.jai", 140723, 3381, 7237},
    {"jaithon/compile/check/predicate.jai", 144104, 1667, 3388},
    {"jaithon/compile/check/relate.jai", 145771, 1321, 2177},
    {"jaithon/compile/check/render.jai", 147092, 2198, 3863},
    {"jaithon/compile/check/stmt.jai", 149290, 21614, 39354},
    {"jaithon/compile/check/substitute.jai", 170904, 1613, 2738},
    {"jaithon/compile/check/suggest.jai", 172517, 1572, 2527},
    {"jaithon/compile/check/ty.jai", 174089, 1844, 3375},
    {"jaithon/compile/check/union.jai", 175933, 1569, 2521},
    {"jaithon/compile/check/universe.jai", 177502, 2323, 4005},
